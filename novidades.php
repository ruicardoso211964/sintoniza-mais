...
<a class="flex items-center gap-3 px-3 py-2 rounded-full bg-primary/20 dark:bg-primary/30 text-gray-900 dark:text-white" href="novidades.php">
...
<h1 class="text-gray-900 dark:text-white text-4xl font-black leading-tight tracking-tight">Novidades Musicais</h1>
</div>
<p class="text-gray-500 dark:text-gray-400">Os últimos lançamentos e novidades.</p>
</div>
<!-- ImageGrid as Artist Cards - Removed for New Releases -->
