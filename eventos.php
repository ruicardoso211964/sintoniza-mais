...
<a href="dashboard.php"><img src="assets/img/logo.png" alt="Sintoniza+ Logo" class="w-full h-auto object-contain"></a>
...
<a class="flex items-center gap-3 px-3 py-2 rounded-full bg-primary/20 dark:bg-primary/30 text-gray-900 dark:text-white" href="eventos.php">
<span class="material-symbols-outlined" style="font-variation-settings: 'FILL' 1;">event</span>
<p class="font-medium">Eventos</p>
</a>
<a class="flex items-center gap-3 px-3 py-2 rounded-full hover:bg-secondary hover:text-white text-gray-600 dark:text-gray-300 dark:hover:bg-secondary dark:hover:text-white" href="meteorologia.php">
...
<a class="flex items-center gap-3 px-3 py-2 rounded-full hover:bg-secondary hover:text-white text-gray-600 dark:text-gray-300 dark:hover:bg-secondary dark:hover:text-white transition-colors" href="admin/admin_fontes.php">
...
<h1 class="text-gray-900 dark:text-white text-4xl font-black leading-tight tracking-tight">Eventos</h1>
</div>
<p class="text-gray-500 dark:text-gray-400">Aqui serão apresentados os próximos eventos.</p>
</div>
<!-- ImageGrid as Artist Cards - Removed for Events -->
